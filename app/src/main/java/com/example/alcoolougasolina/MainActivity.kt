...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Recuperando o estado salvo do switch com SharedPreferences
        val sharedPreferences = getSharedPreferences("MyPrefs", MODE_PRIVATE)
        val editor = sharedPreferences.edit()

        val isChecked = sharedPreferences.getBoolean("SWITCH_STATE", false)
        switchPercentual.isChecked = isChecked
        percentual = if (isChecked) 0.75 else 0.7

        // Listener para alterar o percentual e salvar o estado do switch
        switchPercentual.setOnCheckedChangeListener { _, isChecked ->
            ...
            // Salvando o estado do switch nas SharedPreferences
    ...
    fun escolherCombustivel(percentual: Double) {
        ...
        if (txtAlcool.text.toString() != "" && txtGasolina.text.toString() != "") {
            ...
            resultado.text = "Por favor, preencha todos os campos acima"
        }
    }
